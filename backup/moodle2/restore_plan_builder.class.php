...
require_once($CFG->dirroot . '/backup/moodle2/restore_outcome_area_plugin.class.php');
...
require_once($CFG->dirroot . '/backup/moodle2/backup_outcome_area_plugin.class.php');
