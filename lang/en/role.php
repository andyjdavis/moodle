...
$string['outcome:edit'] = 'Edit outcomes';
$string['outcome:export'] = 'Export outcomes';
$string['outcome:import'] = 'Import outcomes';
$string['outcome:mapoutcomes'] = 'Map outcomes to activities, questions, etc';
$string['outcome:mapoutcomesets'] = 'Map outcome sets to courses';
