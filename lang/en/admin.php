...
$string['pleaserefreshregistration'] = 'Your site has been registered with Moodle.net, please consider updating the registration if significant changes happened since your last update, on {$a}';
$string['pleaserefreshregistrationunknown'] = 'Your site has been registered with moodle.org but the registration date is unknown. Please update your registration.';
...
$string['registermoodleorgli3'] = 'Your site is registered with {$a}. This allows you to <a href="https://docs.moodle.org/en/Publishing_a_course" target="_blank">publish courses to Moodle.net</a>.';
$string['registerwithmoodleorg'] = 'Register your Moodle';
