...
$string['pleaserefreshregistration'] = 'Your site has been registered. Please consider updating the registration if significant changes have happened since your last update on {$a} if you have disabled the \'Site registration\' scheduled task.';
$string['pleaserefreshregistrationunknown'] = 'Your site has been registered but the registration date is unknown. Please update your registration by clicking the \'Update registration\' button or enable the \'Site registration\' scheduled task so that your registration is automatically updated.';
