...
$string['showall'] = 'Show all plugins';
$string['showhighlighted'] = 'Show highlighted plugins only';
$string['pluginchecknotice'] = 'The following table shows plugins that may require your attention during the upgrade. New plugins that are going to be installed, updated plugins that are going to be upgraded and missing plugins are highlighted. All non-standard extensions are highlighted, too. You should check if there is a more recent version of extensions available and eventually update their source code before continuing with this Moodle upgrade.';
