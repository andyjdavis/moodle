...
$string['type_outcomeexport'] = 'Outcome export format';
$string['type_outcomeexport_plural'] = 'Outcome export formats';
$string['type_outcomeimport'] = 'Outcome import format';
$string['type_outcomeimport_plural'] = 'Outcome import formats';
$string['type_outcomesupport'] = 'Outcome supported plugin type';
$string['type_outcomesupport_plural'] = 'Outcome supported plugin types';
