...
$string['allowcalculations'] = 'Allow calculations';
$string['allowcalculations_help'] = 'Allow custom calculations anywhere on the site. If a teacher has already created a calculation, disabling this this will make it impossible for the teacher to change the calculation';
...
$string['overridecat'] = 'Allow category grades to be manually overriden';
...
$string['showcalculations_allowcalculationsdisabled_help'] = 'Calculations have been disabled by the grade_report_allowcalculations setting. If enabled, when editing is turned on, a calculator icon is shown for each grade item and category.';
