...
$string['error_question_hint_missing_in_db'] = 'Unable to import question {$a->oldquestionid} into database as {$a->dbquestionid} because hint "{$a->hint}" did not import correctly.';
