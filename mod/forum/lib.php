 ...
 */
function forum_rating_is_valid($params) {
    global $DB, $USER;
    ...
    $forumsql = "SELECT f.id as fid, d.id as did, p.userid as userid, p.timecreated, f.assesstimestart, f.assesstimefinish, d.groupid
                   FROM {forum_posts} p
                   JOIN {forum_discussions} d ON p.discussion = d.id
    ...
    //need to load the full forum and post objects here as ajax scripts don't like
