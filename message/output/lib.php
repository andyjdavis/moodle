...
abstract class message_output {
     ...
     * Process a message
     *
     * @param stdClass $eventdata The event data submitted by the message provider plus $eventdata->savedmessageid
     */
    public abstract function send_message($message);

    /**
     * Loads the config data from database to put on the config form on the messaging preferences page
     *
    ...
    /**
     * Creates necessary fields in the config form on the messaging preferences page
     *
    ...
    /**
     * Parses the submitted form and saves data into an array of user preferences
     *
    ...
    /**
     * Are the message processor's system setting set up?
     *
